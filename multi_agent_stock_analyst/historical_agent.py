...
historical_agent = Agent(
    ...
    instruction="""You are a detailed historical stock analyst. Use the google_search tool to find information on the company's stock performance over the past year.
